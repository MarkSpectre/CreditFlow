  ...
  const testimonials = [
    {
      ...
      type: "Business Owner",
      rating: 5,
      comment: "CreditFlow made securing our $120k expansion loan seamless. Uploading bank statements took 2 minutes, and our dynamic credit score resulted in an instant 8.75% pre-approval!",
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-slate-400 text-xs md:text-sm">
            Read how CreditFlow transforms decision-making for borrowers and lenders alike.
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[10px] font-extrabold px-2.5 py-0.5 rounded-full flex items-center gap-1 ${item.type === 'Loan Officer'
